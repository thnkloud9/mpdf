...
<p><strong>This orphan part of the paragraph should appear on page two, because it has less than three lines (the default in config.php) before the page end. </strong> Ut enim ad
