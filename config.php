...
$this->minWidowLines = 2; // min number of widow lines required before a page break will be inserted above a block
$this->minOrphanLines = 2; // min number of orphan lines allowed before a page break is inserted above a block
